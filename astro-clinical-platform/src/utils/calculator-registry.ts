...
export class CalculatorRegistry {
  private static instance: CalculatorRegistry | null = null;
  ...
  static getInstance(): CalculatorRegistry {
    if (!this.instance) {
      this.instance = new CalculatorRegistry();
    }
  ...
  private async doInitialize(): Promise<void> {
    ...
    try {
      console.log('🚀 Initializing Calculator Registry...');
      ...
      console.log(`✅ Calculator Registry initialized in ${initTime.toFixed(2)}ms`);
 ...
 */
export async function registerPlugin(plugin: CalculatorPlugin): Promise<void> {
  return calculatorRegistry.register(plugin);
}

/**
 * Convenience function to get a plugin
 */
export function getPlugin(fullId: string): CalculatorPlugin | null {
  return calculatorRegistry.get(fullId);
}

/**
 * Convenience function to search plugins
 */
export function searchPlugins(options: PluginSearchOptions): PluginSearchResult {
  return calculatorRegistry.search(options);
}

/**
 * Convenience function to get all plugins
 */
export function getAllPlugins(): CalculatorPlugin[] {
  return calculatorRegistry.listAll();
}

/**
 * Convenience function to get plugins by namespace
 */
export function getPluginsByNamespace(namespace: string): CalculatorPlugin[] {
  return calculatorRegistry.getByNamespace(namespace);
}
